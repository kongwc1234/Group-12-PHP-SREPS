...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 20, 2021 at 09:27 AM
...
(1, 'Baby Diaper Disposable', 'Baby Diaper-Small Singles', 3, '10.00', 1),
(2, 'Wet Wipes', 'Wet Wipes-10s Pack', 0, '5.00', 2),
(3, 'Antacid', 'Tab digene', 12, '15.00', 3),
(4, 'Glucose', 'Glucose Power 100 grams', 2, '12.00', 4),
(7, 'Panadol', 'For headache', 10, '5.00', 1),
(8, 'AZ', 'covid 19 vaccine', 10, '40.00', 1);
...
(52, '5', '2021-10-14', '14th October 2021 Sales Record'),
(53, '5', '2021-09-14', '14th September 2021 Sales Record'),
(54, '5', '2021-08-14', '14th August 2021 Sales Record');
...
--
ALTER TABLE `sales`
  MODIFY `sales_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
