...
<html>
	...
	<body>
		...
		<?php
				...
				{
					echo "<strong style='color: green'>Sales report has been successfully deleted.</strong>
						<br>
						<br>";
				}

				if(isset($_GET['msg']) && $_GET['msg']=='success_download')
				{
					echo "<strong style='color: green'>Sales report CSV has been successfully downloaded.</strong>
						<br>
						<br>";
				}
				...
				{
					echo "<strong style='color: red'>*Invalid sales report detail, please enter again.</strong>
						<br>
						<br>";
				}
				...
				{
					echo "<strong style='color: green'>The sales report has been successfully edited.</strong>
						<br>
						<br>";
				}
				else if(isset($_GET['msg']) && $_GET['msg']=='failed_edit')
				{
					echo "<strong style='color: red'>*Invalid sales report Details, please enter again.</strong>
						<br>
						<br>";
				}
			?>
...
?>
	<td>
	<form method='post' action='view_sales_report_detail.php'>
...
<?php
			...
			<form action="csv_generator.php" method="post">
			    <input type='submit' class='w3-button w3-khaki' name='Submit' value='Submit' style="width:10%;margin-left:auto">
			</form>
